CREATE DATABASE QUANLY_CUAHANGQUANAO_THHQTCSDL
GO
USE QUANLY_CUAHANGQUANAO_THHQTCSDL
GO
...
(
    ...
    --CONSTRAINT FK_MH_NCC FOREIGN KEY(MANCC) REFERENCES NHACUNGCAP(MANCC),
	--CONSTRAINT FK_MH_CL FOREIGN KEY(MACL) REFERENCES CHATLIEU(MACL)
)
